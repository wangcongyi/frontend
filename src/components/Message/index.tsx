...
const Message: React.FC<Props> = ({ inversion, dateTime, text, error, loading, onRegenerate, onDelete }) => {
  return (
    <div
    ...
    >
      ...
      >
        <p className={classNames(`mb-1 text-xs text-[#b4bbc4]`, inversion ? 'text-right' : 'text-left')}>
          {dateTime}
        </p>
        <div
          className={classNames(
